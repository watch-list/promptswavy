...
function App() {
  ...
  // ---------- UI Pieces ----------
  // Home card styled like attached screenshot
  ...
  function renderFullView(data, options) {
    ...
    return h(
      ...
      h(
        "header",
        {
          className: "pt-4 pb-2 px-4 md:px-0 flex justify-center"
        },
        h(
          "div",
      ...
      h(
        ...
        h(
          ...
          h(
            "div",
            {
              className: "bg-black aspect-[4/5] w-full overflow-hidden"
            },
            data.imageUrl
              ? h("img", {
                  src: data.imageUrl,
      ...
      h(
        ...
        filteredPrompts.length === 0
          ...
          : h(
              ...
              {
                className:
                  "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 md:gap-x-8 md:gap-y-14"
              },
